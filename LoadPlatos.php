<?php
session_start();
$restaurante_conectado=$_SESSION['id'];
if($_POST['page'])
...
$query_pag_data = "SELECT
                            restaurante.id as restaurante,
                            plato.id as id,
                            plato.nombre as nombre,
                            plato.descripcion,
                        ...
                        FROM
                            ...
                            restaurante
                        WHERE
                            plato.id = multimedia.plato_id

                        AND 
                            multimedia.restaurante_id = '".$restaurante_conectado."'
                        AND 
                            multimedia.plato_id is NOT NULL
...
$query_pag_num = "SELECT COUNT(*) AS count FROM plato";
