...
while ($row = mysql_fetch_array($result_pag_data)) {
    ...
    $msg .= "<div class='item  animated bounceIn'> <div class='foto'><a href='infoRestaurant.php?id=".$row['id']."'><img src='imagesRestaurant/".$htmlimg."' alt='imagesRestaurant/".$htmlimg."'/></a></div> <div class='texto'  onclick='mostrar(".$row['id'].")'><p><a href='infoRestaurant.php?id=".$row['id']."'><h2>".$htmlmsg."</h2></a></p></div> </div>";
}
